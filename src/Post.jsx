  ...
  return (
    <div className="card mt-3">
      ...
      <div className="card-body">
        <h5 className="card-title" style={{ fontSize: '1.4rem' }}>{post.title}</h5>
        <p className="card-text" style={{ fontSize: '1.2rem' }}>{post.content}</p>

       
        <button className={`btn ${liked ? 'btn-danger' : 'btn-outline-danger'} btn-sm`} onClick={handleLike}>
          <FontAwesomeIcon icon={faStar} /> {liked ? 'Unlike' : 'Like'}
        </button>
        <hr />
